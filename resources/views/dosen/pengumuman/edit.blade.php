...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('dosen.pengumuman.index') }}" class="px-6 py-2 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-600 transition">
    ...
    <div class="bg-white rounded-lg shadow-md border border-[#D4AF37] overflow-hidden">
        ...
        <form action="{{ route('dosen.pengumuman.update', $pengumuman->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
