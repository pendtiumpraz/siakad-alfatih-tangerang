...
<div class="min-h-screen bg-gradient-to-br from-[#1C3F3A] via-[#2D5F4F] to-[#1C3F3A] py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('dosen.dashboard') }}" class="inline-flex items-center text-white hover:text-gray-200 transition">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div class="p-8">
                ...
                @else
                    <!-- Edit Form -->
                    <form action="{{ route('dosen.username.update') }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] transition"
                        ...
                        <div class="flex justify-end space-x-4 pt-4">
                            <a href="{{ route('dosen.dashboard') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition font-semibold">
                                Batal
                            </a>
                            <button type="submit" class="px-6 py-3 bg-[#D4AF37] text-white rounded-lg hover:bg-[#c49d2f] transition font-semibold shadow-lg">
