...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Calendar View - Jadwal Mengajar</h1>
            <p class="text-gray-600 mt-1">Tampilan kalender pekanan jadwal mengajar Anda</p>
        </div>
        <a href="{{ route('dosen.jadwal-mengajar.index') }}" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors font-semibold shadow-md flex items-center space-x-2">
    ...
    <x-islamic-card title="Filter">
        <form method="GET" action="{{ route('dosen.jadwal-mengajar.calendar') }}" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="jenis_semester" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        <option value="ganjil" {{ $jenis_semester == 'ganjil' ? 'selected' : '' }}>Semester Ganjil</option>
                        <option value="genap" {{ $jenis_semester == 'genap' ? 'selected' : '' }}>Semester Genap</option>
                    </select>
                </div>
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="{{ route('dosen.jadwal-mengajar.calendar') }}" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors font-semibold">
    ...
    <!-- Calendar Grid -->
    <x-islamic-card title="Kalender Pekanan Mengajar">
                                        ...
                                        @if($isStartSlot)
                                            <div class="mb-2 p-2 bg-blue-50 border-l-4 border-blue-500 rounded text-xs hover:bg-blue-100 transition-colors">
                                                ...
                                                <div class="text-gray-700 mb-1">
                                                    <i class="fas fa-book mr-1"></i>{{ $jadwal->mataKuliah->kode_mk ?? '-' }} | {{ $jadwal->mataKuliah->sks ?? '-' }} SKS
                                                </div>
        ...
        <div class="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-gray-700">Jadwal Mengajar Anda</span>
                </div>
                <div class="flex items-center space-x-2">
                    <i class="fas fa-book text-gray-600"></i>
                    <span class="text-gray-700">Kode Mata Kuliah & SKS</span>
                </div>
                <div class="flex items-center space-x-2">
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-700">
                    <strong>Informasi:</strong> Kalender menampilkan seluruh jadwal mengajar Anda dari jam 06:00 hingga 22:00. Gunakan filter untuk melihat jadwal semester Ganjil atau Genap.
                </p>
            </div>
        </div>
    </div>
