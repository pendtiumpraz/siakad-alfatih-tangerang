...
<head>
    ...
    <title>Kwitansi Pembayaran SPP - {{ $pembayaran->mahasiswa->nim }}</title>
    <style>
        @media print {
            body {
                margin: 0;
...
<body>
    <div class="kwitansi-container">
        ...
        <div class="payment-info-box">
            <h3>Informasi Pembayaran SPP (Sumbangan Pembinaan Pendidikan)</h3>
            <p><strong>SPP</strong> adalah biaya pendidikan yang dibayarkan secara rutin setiap semester untuk mendukung proses pembelajaran.</p>
            <p>Pembayaran SPP mencakup: Kegiatan perkuliahan, Fasilitas kampus, dan Pengembangan akademik.</p>

            @if($pembayaran->tanggal_jatuh_tempo)
            <div class="period-badge">
                Periode: {{ $pembayaran->semester->tahun_akademik ?? '-' }} - {{ ucfirst($pembayaran->semester->jenis ?? '-') }}
            </div>
            @endif
        </div>
        ...
        <div class="due-date-alert">
            <strong>⏰ Jatuh Tempo:</strong> {{ \Carbon\Carbon::parse($pembayaran->tanggal_jatuh_tempo)->format('d F Y') }}
        </div>
        @endif
        ...
        <div class="info-section">
            <div class="info-row">
                ...
                <div class="info-value">KWT/SPP/{{ str_pad($pembayaran->id, 6, '0', STR_PAD_LEFT) }}/{{ date('Y') }}</div>
            </div>
            <div class="info-row">
        ...
        <div class="amount-section">
            <div class="amount-label">Total Pembayaran SPP</div>
        ...
        <div class="footer-note">
            ...
            <p>Kwitansi ini sah sebagai bukti pembayaran SPP dan tidak dapat dipindahtangankan.</p>
            <p>Dicetak pada: {{ now()->format('d F Y H:i') }} WIB</p>
            <p style="margin-top: 10px; color: #0891b2; font-weight: bold;">Jazakumullahu khairan - Semoga Allah membalas kebaikan Anda</p>
        </div>
    </div>
