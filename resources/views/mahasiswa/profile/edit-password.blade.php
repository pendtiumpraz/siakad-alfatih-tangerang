...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('mahasiswa.profile') }}" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors font-semibold shadow-md flex items-center space-x-2">
    ...
    <x-islamic-card title="Form Ubah Password">
        <form action="{{ route('mahasiswa.password.update') }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t">
                <a href="{{ route('mahasiswa.profile') }}" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors font-semibold">
                    Batal
                </a>
