...
@section('title', 'Akses KHS Ditolak')
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Akses KHS Ditolak</h1>
            <p class="text-gray-600">Anda belum bisa mengakses Kartu Hasil Studi (KHS)</p>
        </div>
            ...
            <div class="mb-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                    <p class="text-blue-800 text-sm mb-2">
                        <strong>1.</strong> Silakan lakukan pembayaran SPP atau hubungi bagian keuangan untuk negosiasi
                    </p>
                    <p class="text-blue-800 text-sm mb-2">
                        <strong>2.</strong> Setelah pembayaran diproses dan status berubah
                    </p>
                    <p class="text-blue-800 text-sm">
                        <strong>3.</strong> Anda dapat kembali ke halaman ini untuk melihat KHS
                    </p>
                </div>
            </div>
