...
<div class="space-y-6">
    <!-- Page Header -->
    <x-admin.page-header title="Edit Kurikulum" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="tahun_mulai"
                            id="tahun_mulai"
                            value="{{ old('tahun_mulai', $kurikulum->tahun_mulai) }}"
                            min="2000"
                            max="2100"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="tahun_selesai"
                            id="tahun_selesai"
                            value="{{ old('tahun_selesai', $kurikulum->tahun_selesai) }}"
                            min="2000"
                            max="2100"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <input
                                ...
                                name="total_sks"
                                id="total_sks"
                                value="{{ old('total_sks', $kurikulum->total_sks) }}"
                                min="1"
                                max="200"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center space-x-4" x-data="{ isActive: {{ old('is_active', $kurikulum->is_active ? '1' : '0') }} == 1 }">
