...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Tambah Jalur Seleksi</h1>
            <p class="text-gray-600 mt-1">Buat jalur seleksi baru</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200">
        <form action="{{ route('admin.jalur-seleksi.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode_jalur" value="{{ old('kode_jalur') }}" required
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="biaya_pendaftaran" value="{{ old('biaya_pendaftaran', 0) }}" required min="0" step="1000"
                ...
                <div>
                    ...
                    <input type="number" name="kuota_total" value="{{ old('kuota_total') }}" min="0"
            ...
            <div class="mt-6">
                ...
                <textarea name="deskripsi" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                          placeholder="Deskripsi jalur seleksi...">{{ old('deskripsi') }}</textarea>
            </div>
