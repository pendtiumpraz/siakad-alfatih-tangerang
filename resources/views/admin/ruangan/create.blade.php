        ...
        <div class="p-6">
            <form action="{{ route('admin.ruangan.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Tipe Ruangan & URL -->
                    <div class="md:col-span-2" x-data="{ tipe: '{{ old('tipe', 'luring') }}' }">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Tipe Ruangan -->
                            <div>
                            ...
                            <div x-show="tipe === 'daring'" x-cloak>
                                ...
                                <input type="url" name="url" id="url" value="{{ old('url') }}" class="w-full px-4 py-2 border-2 border-[#2D5F3F] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D4AF37] transition @error('url') border-red-500 @enderror" placeholder="https://meet.google.com/xxx">
                                @error('url')
                                    <p class="mt-1 text-sm text-red-500"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                                @enderror
