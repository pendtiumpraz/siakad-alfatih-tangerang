...
<div class="space-y-6">
    <!-- Page Header -->
    <x-admin.page-header title="Edit Ruangan" />
            ...
            <form action="{{ route('admin.ruangan.update', $ruangan->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="kapasitas" id="kapasitas" value="{{ old('kapasitas', $ruangan->kapasitas) }}" min="1" class="w-full px-4 py-2 pr-20 border-2 border-[#2D5F3F] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D4AF37] transition @error('kapasitas') border-red-500 @enderror" placeholder="30" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        @php
                            $existingFasilitas = is_array($ruangan->fasilitas) ? $ruangan->fasilitas : explode(',', $ruangan->fasilitas ?? '');
                            $existingFasilitas = array_map('trim', $existingFasilitas);
                        @endphp
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="checkbox" name="fasilitas[]" value="Proyektor" class="w-4 h-4 text-[#2D5F3F] border-gray-300 rounded focus:ring-[#D4AF37]" {{ in_array('Proyektor', old('fasilitas', $existingFasilitas)) ? 'checked' : '' }}>
                            ...
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="checkbox" name="fasilitas[]" value="AC" class="w-4 h-4 text-[#2D5F3F] border-gray-300 rounded focus:ring-[#D4AF37]" {{ in_array('AC', old('fasilitas', $existingFasilitas)) ? 'checked' : '' }}>
                                <span class="text-sm text-gray-700">
                            ...
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="checkbox" name="fasilitas[]" value="Papan Tulis" class="w-4 h-4 text-[#2D5F3F] border-gray-300 rounded focus:ring-[#D4AF37]" {{ in_array('Papan Tulis', old('fasilitas', $existingFasilitas)) ? 'checked' : '' }}>
                                <span class="text-sm text-gray-700">
                            ...
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="checkbox" name="fasilitas[]" value="Wifi" class="w-4 h-4 text-[#2D5F3F] border-gray-300 rounded focus:ring-[#D4AF37]" {{ in_array('Wifi', old('fasilitas', $existingFasilitas)) ? 'checked' : '' }}>
                                <span class="text-sm text-gray-700">
                            ...
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="checkbox" name="fasilitas[]" value="Lab Komputer" class="w-4 h-4 text-[#2D5F3F] border-gray-300 rounded focus:ring-[#D4AF37]" {{ in_array('Lab Komputer', old('fasilitas', $existingFasilitas)) ? 'checked' : '' }}>
                                <span class="text-sm text-gray-700">
                            ...
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="checkbox" name="fasilitas[]" value="Sound System" class="w-4 h-4 text-[#2D5F3F] border-gray-300 rounded focus:ring-[#D4AF37]" {{ in_array('Sound System', old('fasilitas', $existingFasilitas)) ? 'checked' : '' }}>
                                <span class="text-sm text-gray-700">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center space-x-4" x-data="{ isAvailable: {{ old('is_available', $ruangan->is_available ? '1' : '0') }} == 1 }">
                            <label class="flex items-center cursor-pointer">
                                <div class="relative">
                                    <input type="checkbox" name="is_available" value="1" x-model="isAvailable" class="sr-only" {{ old('is_available', $ruangan->is_available) ? 'checked' : '' }}>
