...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.penggajian.show', $penggajian->id) }}" class="px-6 py-2 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-600 transition">
        ...
        <div class="lg:col-span-2">
            <form action="{{ route('admin.penggajian.storePayment', $penggajian->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md border border-[#D4AF37] p-6 space-y-6">
                ...
                <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                    <a href="{{ route('admin.penggajian.show', $penggajian->id) }}" class="px-6 py-2 bg-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-400 transition">
                        Batalkan
                    </a>
