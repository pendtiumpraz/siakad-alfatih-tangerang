        ...
        <form action="{{ route('admin.jadwal.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="jenis_semester_display" disabled value="{{ old('jenis_semester') ? (old('jenis_semester') == 'ganjil' ? 'Semester Ganjil' : 'Semester Genap') : 'Otomatis dari Mata Kuliah' }}" 
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed">
                    <input type="hidden" id="jenis_semester_input" name="jenis_semester" value="{{ old('jenis_semester') }}" required>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="kelas" required value="{{ old('kelas') }}" placeholder="A, B, C, D, E, dll" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
...
$(document).ready(function() {
    ...
    // Trigger change on page load if mata kuliah already selected (for old() values)
