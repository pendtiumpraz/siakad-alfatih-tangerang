                ...
                <div class="flex items-center justify-between px-4 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            >
                                <img src="https://ui-avatars.com/api/?name={{ auth()->user()->name ?? 'Mahasiswa' }}&background=4A7C59&color=fff"
                                     alt="Profile"
                                     class="w-10 h-10 rounded-full ring-2 ring-[#D4AF37]">
                                <div class="hidden md:block text-left">
                                    <div class="text-sm font-semibold text-gray-800">{{ auth()->user()->name ?? 'Mahasiswa' }}</div>
