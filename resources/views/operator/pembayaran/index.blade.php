                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <div class="flex items-center space-x-2">
                        @if($pembayaran->trashed())
                            <!-- Restore Button -->
                            <form action="{{ route('operator.pembayaran.restore', $pembayaran->id) }}" method="POST" class="inline" onsubmit="return confirmRestore(this, 'pembayaran ini')">
                                @csrf
                        ...
                        @else
                            ...
                            <!-- Cetak Kwitansi -->
                            <a href="{{ route('operator.pembayaran.kwitansi', $pembayaran->id) }}" target="_blank" class="text-purple-600 hover:text-purple-800" title="Cetak Kwitansi">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- Soft Delete Button -->
                            <form action="{{ route('operator.pembayaran.destroy', $pembayaran->id) }}" method="POST" class="inline" onsubmit="return confirmDelete(this, 'pembayaran ini')">
                                @csrf
                                @method('DELETE')
