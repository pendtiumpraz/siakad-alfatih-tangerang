                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <div class="flex items-center space-x-2">
                        @if($pembayaran->trashed())
                            <!-- Restore Button -->
                            <form action="{{ route('operator.pembayaran.restore', $pembayaran->id) }}" method="POST" class="inline">
                                @csrf
                            ...
                            <!-- Force Delete Button -->
                            <form action="{{ route('operator.pembayaran.force-delete', $pembayaran->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-600 hover:text-red-800" title="Hapus Permanen" onclick="return confirm('PERINGATAN: Hapus permanen pembayaran ini? Data tidak dapat dikembalikan!')">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @else
                            ...
                            <!-- Soft Delete Button -->
                            <form action="{{ route('operator.pembayaran.destroy', $pembayaran->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
