...
<div class="space-y-6">
    ...
    <x-islamic-card title="Informasi Pembayaran">
        <form action="{{ route('operator.pembayaran.update', 1) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="mahasiswa_id" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        ...
                        <option value="1" selected>2301001 - Ahmad Nur Rahman</option>
                ...
                <div>
                    ...
                    <select name="jenis" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="nominal" required min="0" value="2500000" class="w-full pl-12 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    @error('nominal')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_jatuh_tempo" required value="{{ \Carbon\Carbon::now()->addDays(30)->format('Y-m-d') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_bayar" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    @error('tanggal_bayar')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                ...
                <textarea name="keterangan" rows="4" placeholder="Masukkan keterangan tambahan..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">Pembayaran SPP Semester 3</textarea>
                @error('keterangan')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                <x-file-upload
                    ...
                    accept="image/*,.pdf"
                    currentFile="pembayaran/bukti_pembayaran_sample.pdf"
                />
