...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <form method="GET" action="{{ route('operator.krs-approval.detail', $prodi->id) }}" class="space-y-4">
            ...
            @if(request()->hasAny(['krs_status', 'payment_status', 'search']))
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('operator.krs-approval.detail', ['prodiId' => $prodi->id, 'semester_id' => $semester->id]) }}" 
    ...
    <form id="massApproveForm" action="{{ route('operator.krs-approval.mass-approve-selected') }}" method="POST">
        @csrf
        <input type="hidden" name="semester_id" value="{{ $semester->id }}">
                        ...
                        @forelse($mahasiswas as $mhs)
                            <tr class="hover:bg-gray-50 {{ !$mhs->can_approve ? 'bg-gray-50' : '' }}">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <a href="{{ route('operator.krs-approval.show', ['mahasiswaId' => $mhs->id, 'semester_id' => $semester->id]) }}" 
