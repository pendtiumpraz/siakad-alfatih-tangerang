...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-gradient-to-r from-[#2D5F3F] to-[#4A7C59] rounded-lg shadow-md p-6 mb-6 border-2 border-[#D4AF37]">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('operator.keuangan.create') }}" class="px-6 py-2 bg-[#D4AF37] hover:bg-yellow-600 text-white font-semibold rounded-lg transition flex items-center space-x-2">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" action="{{ route('operator.keuangan.index') }}" class="flex items-end gap-4">
            <div class="flex-1">
            ...
            <a href="{{ route('operator.keuangan.show', $semester->id) }}" class="px-6 py-2 bg-[#2D5F3F] hover:bg-[#4A7C59] text-white font-semibold rounded-lg transition">
