    ...
    <div class="bg-gradient-to-r from-[#2D5F3F] to-[#4A7C59] rounded-lg shadow-md p-6 mb-6 border-2 border-[#D4AF37]">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('operator.keuangan.create') }}" class="px-4 py-2 bg-[#D4AF37] hover:bg-yellow-600 text-white font-semibold rounded-lg transition">
                    <i class="fas fa-plus mr-2"></i>Input Manual
                </a>
                <a href="{{ route('operator.keuangan.index') }}" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg transition">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('operator.keuangan.show', $semester->id) }}" class="px-6 py-2 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-600 transition">
