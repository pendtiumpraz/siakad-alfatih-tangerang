...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-gradient-to-r from-[#2D5F3F] to-[#4A7C59] rounded-lg shadow-md p-6 mb-6 border-2 border-[#D4AF37]">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('operator.keuangan.index') }}" class="px-6 py-2 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg transition">
    ...
    @else
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('operator.keuangan.update', $pembukuan->id) }}" method="POST" enctype="multipart/form-data" id="keuanganForm">
                @csrf
                @method('PUT')
                ...
                <div class="mt-8 flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('operator.keuangan.index') }}" class="px-6 py-2 bg-gray-500 hover:bg-gray-600 text-white font-semibold rounded-lg transition">
                            Batal
                        </a>
