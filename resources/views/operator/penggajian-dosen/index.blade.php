...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md border border-[#D4AF37] p-6">
        ...
        <form method="GET" action="{{ route('operator.penggajian.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
            ...
            <div>
                ...
                <div class="flex space-x-2">
                    ...
                    @if(request()->hasAny(['status', 'periode', 'search']))
                        <a href="{{ route('operator.penggajian.index') }}" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition font-semibold">
                            Reset
                        </a>
                    @endif
                </div>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('operator.penggajian.show', $penggajian->id) }}" class="text-blue-600 hover:text-blue-800 transition" title="Detail">
                                    ...
                                    @elseif($penggajian->canBePaid())
                                        <a href="{{ route('operator.penggajian.payment', $penggajian->id) }}" class="p-2 bg-green-500 text-white rounded hover:bg-green-600 transition" title="Proses Pembayaran">
