    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-2">
            @if($penggajian->canBePaid())
                <a href="{{ route('operator.penggajian.payment', $penggajian->id) }}" class="px-6 py-2 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition">
                    <i class="fas fa-money-bill-wave mr-2"></i>
                    Proses Pembayaran
                </a>
            @endif
            <a href="{{ route('operator.penggajian.index') }}" class="px-6 py-2 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-600 transition">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if($penggajian->canBeVerified())
                <div class="bg-white rounded-lg shadow-md border border-[#D4AF37] p-6">
                    ...
                    <form action="{{ route('operator.penggajian.verify', $penggajian->id) }}" method="POST" class="space-y-4">
                        @csrf
                        ...
                        <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                            <a href="{{ route('operator.penggajian.index') }}" class="px-6 py-2 bg-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-400 transition">
                                Batalkan
                            </a>
